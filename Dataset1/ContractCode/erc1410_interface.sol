...
contract IERC1410 {
    ...
    // Token Transfers
    function transferByPartition(bytes32 _partition, address _to, uint256 _value, bytes _data) external returns (string);//bytes32 error!
    ...
    function isOperator(address _operator, address _tokenHolder) external view;// returns (bool) error!
