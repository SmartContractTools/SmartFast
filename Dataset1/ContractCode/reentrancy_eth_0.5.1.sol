...
contract Reentrancy {
    ...
    function withdrawBalance() public{
        ...
        (bool ret, bytes memory mem) = msg.sender.call.value(userBalance[msg.sender])("");  //eth
        if( ! ret ){
            revert();
        }
    ...
    function withdrawBalance_fixed() public{
        ...
        userBalance[msg.sender] = 0;
        (bool ret, bytes memory mem) = msg.sender.call.value(amount)(""); //good
        if( ! ret ){
            revert();
        }
    }   
    ...
    function withdrawBalance_fixed_2() public{
        ...
        msg.sender.transfer(userBalance[msg.sender]); //no-gas
        userBalance[msg.sender] = 0;
    }   
