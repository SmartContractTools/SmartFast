...
contract BondData is ERC20Detailed, ERC20Burnable, ReentrancyGuard {
    ...
    uint256 public totalBondIssuance; //USDT
    uint256 public actualBondIssuance; //
    uint256 public mintCnt;//
    uint256 public par; //,USDT or DAI
    uint256 public couponRate; // 15%

    uint256 public maturity; //,(30)
    uint256 public issueFee; //,0.2%
    ...
    bool public supportRedeem;//, , truefalse
    ...
    uint256 public liquidateLine = 7e17;//30% 1-0.3 = 0.7
    ...
    struct Balance {
        //
        //amountGive: token
        //amountGet: tokenUSDTUSDC

        //
        //amountGive: tokenUSDTUSDC
        //amountGet: 
        uint256 amountGive;
        uint256 amountGet;
    }
    ...
    uint256 public totalProfits;    //,  @fee.
...
contract BondFactory {
    ...
    //info[5]: _financePurposeHash,//hash
    //info[6]: _paymentSourceHash,//hash
    //info[7]: _issueTimestamp,//
