...
This Ethereum smart contract mints 1 CYPHR token for 0.001 ether -- up to 1000 tokens (1 ether ).
...
contract CYPHRtoken is ERC20Burnable {
	...
	uint256 public fee = 1000000000000000; // "0.001" ether () rate for 1 CYPHR
	address payable public beneficiary = 0xBBE222Ef97076b786f661246232E41BE0DFf6cc4; // address to receive contributed ether ()

	/**
	* @dev See `ERC20._mint`.
 	* 
 	* Public function to contribute ether () and receive CYPHR
 	*/
