...
contract CoinAtc // @eachvar
{
    ...
    address public account_address = 0x6dFe4B3AC236A392a6dB25A8cAc27b0fC563B0Da; // @eachvar 
    ...
    // =========  ===============
    bool public direct_drop_switch = true; //  @eachvar
    uint256 public direct_drop_rate = 10000; // ethwei @eachvar
    address public direct_drop_address = 0x5D9789bE0Fd19299443F8bA61658C0afb1De0379; //  @eachvar
    address public direct_drop_withdraw_address = 0x6dFe4B3AC236A392a6dB25A8cAc27b0fC563B0Da; //  @eachvar

    bool public direct_drop_range = false; //  @eachvar
    uint256 public direct_drop_range_start = 1568081880; //  @eachvar
    uint256 public direct_drop_range_end = 1599617880; //  @eachvar
    ...
    returns (bool)
    {
        ...
        uint256 tokenAmount = div(mul(msg.value,direct_drop_rate ), 10**18); // 18 wei to  ether  decimals,
     ...
     // =========  ===============
    bool public air_drop_switch = true; //  @eachvar
    uint256 public air_drop_rate = 300; // rate @eachvar
    address public air_drop_address = 0x5D9789bE0Fd19299443F8bA61658C0afb1De0379; //  @eachvar
    uint256 public air_drop_count = 1; //  @eachvar

    mapping(address => uint256) airdrop_times; // mapping

    bool public air_drop_range = false; //  @eachvar
    uint256 public air_drop_range_start = 1568081880; //  @eachvar
    uint256 public air_drop_range_end = 1599617880; //  @eachvar
