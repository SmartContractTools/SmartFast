...
// File: contracts\MEDBToken.sol

contract MEDBToken is DetailedERC20, StandardToken, Ownable {
  string public name = "Medical Platform Bloodlink";
  string public symbol = "MEDB";
  uint8 public decimals = 18;
  uint public initialSupply = 4000000000 * 10 ** uint256(decimals);
