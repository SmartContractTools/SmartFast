...
contract OfferToken is LexDAORole, ERC20Burnable, ERC20Capped {
    ...
    ***************/
    ...
    uint256 public rate; // mint rate amount of OfferToken to ether () / e.g., '10' = 1 ETH mints 10 offerToken
    ...
    ***************/
    ...
    MARKET FUNCTIONS
    ***************/
    function buyOfferToken() public payable { // public can swap ether () for OfferToken at registered rate
        ...
        _owner.transfer(msg.value); // forwards ether () to offeror-owner 
    }
    ...
    ***************/
    ...
    // - MGMT
    function adjustOfferRate(uint256 newRate) public onlyOwner { // owner can adjust rate between ether () and OfferToken
        rate = newRate;
    }
