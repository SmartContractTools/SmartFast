    ...
    ReentrancyGuard
{
     ...
     * with a low gas price and iterateChunkAuction is called before that transaction is mined. When the bidders
     ...
     * The intended use case is that the bidder would retrieve the Rebalancing SetTokens lastChunkAuctionEnd
