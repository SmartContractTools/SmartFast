...
Upon calling the "payRetainerFee" function in the ascribed *uint256* public fee amount () ("Retainer Fee")
...
or a full refund () shall be promptly returned to msg.sender(s). 
