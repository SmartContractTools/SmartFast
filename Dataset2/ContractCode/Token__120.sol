/*! KloowayBET.sol | (c) 2019 Developed by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | License: MIT */
...
contract Token is RewardTokenInUSDT, CappedToken, BurnableToken, Withdrawable {
    constructor() CappedToken(1000000000) StandardToken("KloowayBET", "KLWS", 0) public {
