...
contract VONNI is IERC20 {
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        uint256 basis_timestamp1 = now - 1577836800 + 2592000;// 1577836800 <= : 2020-01-01
        uint256 basis_timestamp2 = now - 1580515200 + 2592000;// 1577836800 <= : 2020-02-01
        uint256 basis_timestamp3 = now - 1583020800 + 2592000;// 1577836800 <= : 2020-03-01
        uint256 basis_timestamp4 = now - 1585699200 + 2592000;// 1577836800 <= : 2020-04-01
        uint256 basis_timestamp5 = now - 1588291200 + 2592000;// 1577836800 <= : 2020-05-01
        uint256 basis_timestamp6 = now - 1590969600 + 2592000;// 1577836800 <= : 2020-05-01
