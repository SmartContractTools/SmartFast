...
contract offerToken is ERC20Burnable {
    ...
    function adjustOfferRate(uint256 newRate) public onlyOfferor { // offeror can adjust rate between ether () and offerToken
        rate = newRate;
    }
    ...
    function buyOfferToken() public payable { // public can swap ether () for offerToken at registered rate
        ...
        offeror.transfer(msg.value); // forwards ether () to offeror 
    }
