...
from smartfast.report import Report
    ...
    try:
        ...
        if printer_classes:
            ...
            logger.info('%s analyzed (%d contracts with %d detectors), %d result(s) found', filename,
                        number_contracts, len(detector_classes)+27, len(results_detectors))
                        ...
                        if 'elements' in element and element['elements']:
                            ...
                            for elements_val in element['elements']:
                                if 'type' in elements_val and elements_val['type'] == "node":
                                    if 'source_mapping' in elements_val and 'lines' in elements_val['source_mapping'] and elements_val['source_mapping']['lines']:
