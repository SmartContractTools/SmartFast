...
from smartfast.core.solidity_types import ElementaryType, TypeInformation
from smartfast.exceptions import SmartfastException

if TYPE_CHECKING:
    from smartfast.core.declarations import Import
...
SOLIDITY_FUNCTIONS: Dict[str, List[str]] = {
    ...
    # and converted to a SolidityFunction by SmartIR
...
class SolidityVariable(Context):
    ...
    def state_variable(self):
        ...
        raise SmartfastException(to_log)
