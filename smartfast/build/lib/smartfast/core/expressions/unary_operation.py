...
from smartfast.core.exceptions import SmartfastCoreError
...
class UnaryOperationType(Enum):
    ...
    def get_type(operation_type, isprefix):
        ...
        raise SmartfastCoreError("get_type: Unknown operation type {}".format(operation_type))
    ...
    def __str__(self):
        ...
        raise SmartfastCoreError("str: Unknown operation type {}".format(self))
    ...
    def is_prefix(operation_type):
        ...
        raise SmartfastCoreError("is_prefix: Unknown operation type {}".format(operation_type))
