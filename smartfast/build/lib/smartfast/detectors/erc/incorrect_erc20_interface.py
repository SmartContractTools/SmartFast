...
class IncorrectERC20InterfaceDetection(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#incorrect-erc20-interface'
...
`Token.transfer` does not return a boolean. Bob deploys the token. Alice creates a contract that interacts with it but assumes a correct `ERC20` interface implementation. Alice's contract is unable to interact with Bob's contract.'''
    ...
    def detect_incorrect_erc20_interface(contract):
        ...
        if contract.is_possible_erc721() or contract.is_possible_erc621():
            return []
