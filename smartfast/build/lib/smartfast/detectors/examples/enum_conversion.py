...
from smartfast.smartir.operations import TypeConversion
from smartfast.core.declarations.enum import Enum
...
class EnumConversion(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#dangerous-enum-conversion"
...
Attackers can trigger unexpected behaviour by calling `bug(1)`."""
    ...
    def _detect(self):
        ...
        if not _uses_vulnerable_solc_version(self.smartfast.solc_version):
            return results
