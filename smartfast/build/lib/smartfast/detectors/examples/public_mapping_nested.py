...
class PublicMappingNested(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#public-mappings-with-nested-variables"
    ...
    def _detect(self):
        ...
        for p in self.smartfast.pragma_directives:
            if "0.5.0" in p.version and not "<0.5.0" in p.version:
                return []
        if self.smartfast.solc_version and self.smartfast.solc_version.startswith("0.5."):
            return []
