...
class ReusedBaseConstructor(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#reused-base-constructors"
...
."""
    ...
    def _detect_explicitly_called_base_constructors(self, contract):
        ...
        while len(queued_contracts) > 0:
            ...
            if self.smartfast.solc_version >= "0.4.22":
    ...
    def _detect(self):
        ...
        if not self.smartfast.solc_version.startswith("0.4."):
            return []
