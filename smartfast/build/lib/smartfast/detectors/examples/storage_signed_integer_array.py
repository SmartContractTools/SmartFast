...
from smartfast.core.solidity_types.elementary_type import Int, ElementaryType
...
from smartfast.smartir.operations.assignment import Assignment
from smartfast.smartir.operations.init_array import InitArray
...
class StorageSignedIntegerArray(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#storage-signed-integer-array"
    )
