...
def _find_missing_inheritance(smartfast):
    """
    ...
    :return:
    """
    missings = smartfast.contracts_with_missing_inheritance
...
class NameReused(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#name-reused'
...
'''
    ...
    def _detect(self):
        ...
        names_reused = self.smartfast.contract_name_collisions
        # print("names_reused:")
        # print([v.name for v in names_reused.keys()])
        ...
        # print("incorrectly_constructed:")
        # print([v.name for v in incorrectly_constructed])
        ...
        most_base_with_missing_inheritance = _find_missing_inheritance(self.smartfast)

        for b in most_base_with_missing_inheritance:
            info = [b, ' inherits from a contract for which the name is reused.\n']
            if b.inheritance:
                info += ['\t- Smartfast could not determine which contract has a duplicate name:\n']
