...
class RightToLeftOverride(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#right-to-left-override-character'
...
'''
    ...
    def _detect(self):
        ...
        for filename, source in self.smartfast.source_code.items():
            ...
            while True:
                ...
                if result_index == -1:
                    ...
                    relative = self.smartfast.crytic_compile.filename_lookup(filename).relative
