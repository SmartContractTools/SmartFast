...
from smartfast.smartir.operations import Assignment, Length
...
class ArrayLengthAssignment(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#array-length-assignment"
