...
from smartfast.smartir.operations import Binary, Assignment, BinaryType, LibraryCall
...
class DivideBeforeMultiply(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#divide-before-multiply'
...
In general, it's usually a good idea to re-arrange arithmetic to perform multiplication before division, unless the limit of a smaller type makes this dangerous.'''
    ...
    def _explore(self, node, explored, f_results, divisions):
        # print(node)
        # print("-----")
        # print([node._node_type for node in explored])
        # for f in explored:
            # print(f)
        # print("******")
        if node in explored:
