...
from smartfast.core.solidity_types import MappingType, UserDefinedType
from smartfast.detectors.abstract_detector import AbstractDetector, DetectorClassification
from smartfast.smartir.operations import Delete
...
class MappingDeletionDetection(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#deletion-on-mapping-containing-a-structure"
