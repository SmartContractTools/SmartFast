...
from smartfast.core.expressions.unary_operation import UnaryOperationType, UnaryOperation
...
class IncorrectUnaryExpressionDetection(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#dangerous-unary-expressions"
    )
