...
from smartfast.smartir.operations import LowLevelCall, SolidityCall
...
class UnprotectedUpgradeable(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#unprotected-upgradeable-contract"
