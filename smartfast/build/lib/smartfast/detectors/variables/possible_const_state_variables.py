...
from smartfast.formatters.variables.possible_const_state_variables import custom_format as format
...
class ConstCandidateStateVars(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#state-variables-that-could-be-declared-constant'
    ...
    def _detect(self):
        ...
        all_variables = [c.state_variables for c in self.smartfast.contracts]
        ...
        all_functions = [c.all_functions_called for c in self.smartfast.contracts]
