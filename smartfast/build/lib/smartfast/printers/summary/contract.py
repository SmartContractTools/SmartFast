...
from smartfast.utils.colors import blue, green, magenta
...
class ContractSummary(AbstractPrinter):
    ...
    WIKI = "https://github.com/trailofbits/smartfast/wiki/Printer-documentation#contract-summary"
    ...
    def output(self, _filename):  # pylint: disable=too-many-locals
        ...
        for c in self.contracts:
            ...
            if c in self.smartfast.contracts_derived:
            ...
            additional_fields = output.Output(
                ...
                additional_fields={
                    ...
                    "is_most_derived": c in self.smartfast.contracts_derived,
                },
            )
