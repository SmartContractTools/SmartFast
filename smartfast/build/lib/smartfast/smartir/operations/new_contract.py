from smartfast.smartir.operations import Call, OperationWithLValue
...
class NewContract(Call, OperationWithLValue):  # pylint: disable=too-many-instance-attributes
    ...
    def contract_created(self):
        ...
        contract_instance = self.smartfast.get_contract_from_name(contract_name)
    ...
    def can_reenter(self, callstack=None):
        """
        Must be called after smartIR analysis pass
