from smartfast.core.expressions import Literal
from smartfast.tools.mutator.mutators.abstract_mutator import AbstractMutator, FaultNature, FaulClass
from smartfast.tools.mutator.utils.generic_patching import remove_assignement
