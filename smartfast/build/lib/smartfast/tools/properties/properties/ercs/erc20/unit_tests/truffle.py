...
from smartfast.tools.properties.platforms.truffle import (
    generate_migration,
    generate_unit_test,
)
from smartfast.tools.properties.properties.ercs.erc20.properties.initialization import ERC20_CONFIG
from smartfast.tools.properties.properties.properties import Property
...
def generate_truffle_test(
    ...
    output_dir = Path(contract.smartfast.crytic_compile.target)
