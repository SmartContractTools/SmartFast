...
from smartfast.tools.similarity.encode import encode_contract, load_and_encode, parse_target
from smartfast.tools.similarity.model import load_model
from smartfast.tools.similarity.similarity import similarity
