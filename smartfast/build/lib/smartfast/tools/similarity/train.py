...
from smartfast.tools.similarity.cache import save_cache
from smartfast.tools.similarity.encode import encode_contract, load_contracts
from smartfast.tools.similarity.model import train_unsupervised
