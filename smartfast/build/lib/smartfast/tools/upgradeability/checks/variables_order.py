...
class MissingVariable(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Upgradeability-Checks#missing-variables"
...
class DifferentVariableContractProxy(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Upgradeability-Checks#incorrect-variables-with-the-proxy"
...
class DifferentVariableContractNewContract(DifferentVariableContractProxy):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Upgradeability-Checks#incorrect-variables-with-the-v2"
...
class ExtraVariablesProxy(AbstractCheck):
    ...
    WIKI = (
        "https://github.com/SmartContractTools/SmartFast/wiki/Upgradeability-Checks#extra-variables-in-the-proxy"
    )
...
class ExtraVariablesNewContract(ExtraVariablesProxy):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Upgradeability-Checks#extra-variables-in-the-v2"
