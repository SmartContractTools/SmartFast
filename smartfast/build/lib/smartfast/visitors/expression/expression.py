...
from smartfast.core.expressions.assignment_operation import AssignmentOperation
from smartfast.core.expressions.binary_operation import BinaryOperation
...
from smartfast.core.expressions.unary_operation import UnaryOperation
...
class ExpressionVisitor:
    ...
    def _visit_expression(self, expression: Expression):  # pylint: disable=too-many-branches
        ...
        if isinstance(expression, AssignmentOperation):
            ...
            raise SmartfastError("Expression not handled: {}".format(expression))
