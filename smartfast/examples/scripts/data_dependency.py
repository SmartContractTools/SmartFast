...
from smartfast.analyses.data_dependency.data_dependency import (
    is_dependent,
    is_tainted,
)
...
contract = smartfast.get_contract_from_name("Simple")
assert contract
...
contract = smartfast.get_contract_from_name("Reference")
assert contract
destination = contract.get_state_variable_from_name("destination")
assert destination
source = contract.get_state_variable_from_name("source")
...
contract = smartfast.get_contract_from_name("SolidityVar")
assert contract
...
contract = smartfast.get_contract_from_name("Intermediate")
assert contract
destination = contract.get_state_variable_from_name("destination")
assert destination
source = contract.get_state_variable_from_name("source")
...
contract = smartfast.get_contract_from_name("Base")
contract_derived = smartfast.get_contract_from_name("Derived")
destination = contract.get_state_variable_from_name("destination")
source = contract.get_state_variable_from_name("source")
...
contract = smartfast.get_contract_from_name("PropagateThroughArguments")
assert contract
