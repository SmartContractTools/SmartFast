...
class FunctionContract(Function, ChildContract, ChildInheritance, SourceMapping):
    ...
    def generate_smartir_ssa(self, all_ssa_state_variables_instances):
        from smartfast.smartir.utils.ssa import add_ssa_ir, transform_smartir_vars_to_ssa
        from smartfast.core.dominators.utils import (
        ...
        transform_smartir_vars_to_ssa(self)
