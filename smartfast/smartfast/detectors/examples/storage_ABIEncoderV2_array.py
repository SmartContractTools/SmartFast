...
from smartfast.smartir.operations import EventCall
...
class ABIEncoderV2Array(AbstractDetector):
    ...
    WIKI = (
        "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#storage-abiencoderv2-array"
    )
...
"""
    ...
    def _detect(self):
        ...
        if not any(
            ...
            for p in self.smartfast.pragma_directives
        ):
            return results
