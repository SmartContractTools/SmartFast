...
from smartfast.smartir.operations import (InternalCall, InternalDynamicCall)
from smartfast.formatters.functions.external_function import custom_format as format
...
class ExternalFunction(AbstractDetector):
    ...
    https://github.com/trailofbits/smartfast/pull/53#issuecomment-432809950
    """
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#public-function-that-could-be-declared-external'
            ...
            for node in func.nodes:
                ...
                for ir in node.irs:
                    ...
                    if isinstance(ir, (InternalDynamicCall)):
                        # function_parameters_writtent("----------InternalDynamicCall--------------")
                        # print(node)
                        return True
        return False
