...
from smartfast.formatters.naming_convention.naming_convention import custom_format as format
...
class NamingConvention(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#conformity-to-solidity-naming-conventions'
