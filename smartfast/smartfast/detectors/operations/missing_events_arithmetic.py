...
from smartfast.smartir.operations.event_call import EventCall
from smartfast.core.solidity_types.elementary_type import ElementaryType, Int, Uint
...
class MissingEventsArithmetic(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#missing-events-arithmetic"
