...
class SimilarVarsDetection(AbstractDetector):
    ...
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#variable-names-are-too-similar"
...
contract SimilarVariables {
    ...
    uint similarvariables4 = 4;
    uint similarvariables5 = 5;
}
```
