...
from smartfast.smartir.operations import InternalCall, LibraryCall
...
class UninitializedStateVarsDetection(AbstractDetector):
    ...
    WIKI = 'https://github.com/SmartContractTools/SmartFast/wiki/Detector-Documentation#uninitialized-state-variables'
