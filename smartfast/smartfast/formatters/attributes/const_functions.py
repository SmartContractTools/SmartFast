import re
from smartfast.formatters.exceptions import FormatError
...
def custom_format(smartfast, result):
    ...
    for element in elements:
        if element["type"] != "function":
            ...
            continue
        target_contract = smartfast.get_contract_from_name(
...
def _patch(smartfast, result, in_file, modify_loc_start, modify_loc_end):
