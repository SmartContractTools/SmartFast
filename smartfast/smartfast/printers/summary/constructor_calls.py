...
class ConstructorPrinter(AbstractPrinter):
    WIKI = "https://github.com/SmartContractTools/SmartFast/wiki/Printer-documentation#constructor-calls"
    ...
    def _get_soruce_code(self, cst):
        ...
        content = self.smartfast.source_code[src_mapping["filename_absolute"]]
