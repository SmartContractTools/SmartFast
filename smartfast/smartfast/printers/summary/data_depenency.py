...
from smartfast.analyses.data_dependency.data_dependency import get_dependencies
from smartfast.smartir.variables import TemporaryVariable, ReferenceVariable
...
class DataDependency(AbstractPrinter):
    ...
    WIKI = "https://github.com/trailofbits/smartfast/wiki/Printer-documentation#data-dependencies"
