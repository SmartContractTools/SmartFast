...
def transform_smartir_vars_to_ssa(function):
    """
    Transform smartIR vars to SSA (TemporaryVariable, ReferenceVariable, TupleVariable)
    """
    variables = []
...
def copy_ir(ir, *instances):
    ...
    raise SmartIRError("Impossible ir copy on {} ({})".format(ir, type(ir)))
