...
from smartfast.core.variables.event_variable import EventVariable
from smartfast.solc_parsing.variables.event_variable import EventVariableSolc
from smartfast.core.declarations.event import Event
    ...
    def analyze(self, contract: "ContractSolc"):
        for elem_to_parse in self._elemsNotParsed:
            ...
            if "src" in elem_to_parse:
                elem.set_offset(elem_to_parse["src"], self._parser_contract.smartfast)
