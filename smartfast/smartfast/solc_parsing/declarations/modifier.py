...
from smartfast.core.cfg.node import link_nodes
from smartfast.core.declarations.modifier import Modifier
...
class ModifierSolc(FunctionSolc):
    def __init__(
        ...
        super().__init__(modifier, function_data, contract_parser, smartfast_parser)
