...
from smartfast.core.declarations import Event, Enum, Structure
...
from smartfast.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from smartfast.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
from smartfast.core.expressions.call_expression import CallExpression
from smartfast.core.expressions.conditional_expression import ConditionalExpression
from smartfast.core.expressions.elementary_type_name_expression import ElementaryTypeNameExpression
from smartfast.core.expressions.identifier import Identifier
from smartfast.core.expressions.index_access import IndexAccess
from smartfast.core.expressions.literal import Literal
from smartfast.core.expressions.member_access import MemberAccess
from smartfast.core.expressions.new_array import NewArray
from smartfast.core.expressions.new_contract import NewContract
from smartfast.core.expressions.new_elementary_type import NewElementaryType
from smartfast.core.expressions.super_call_expression import SuperCallExpression
from smartfast.core.expressions.super_identifier import SuperIdentifier
from smartfast.core.expressions.tuple_expression import TupleExpression
from smartfast.core.expressions.type_conversion import TypeConversion
from smartfast.core.expressions.unary_operation import UnaryOperation, UnaryOperationType
from smartfast.core.solidity_types import (
    ArrayType,
    ElementaryType,
    FunctionType,
    MappingType,
...
from smartfast.solc_parsing.exceptions import ParsingError, VariableNotFound
from smartfast.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def _find_variable_init(
...
) -> Tuple[List[Contract], Union[List["FunctionSolc"]], "SmartfastCore", "SmartfastSolc"]:
    from smartfast.solc_parsing.smartfastSolc import SmartfastSolc
    from smartfast.solc_parsing.declarations.contract import ContractSolc
    from smartfast.solc_parsing.declarations.function import FunctionSolc
    ...
    if isinstance(caller_context, SmartfastSolc):
        ...
        sl = caller_context.smartfast
        sl_parser = caller_context.smartfast_parser
...
def parse_call(expression: Dict, caller_context):  # pylint: disable=too-many-statements
    ...
    if type_conversion:
        ...
        t.set_offset(src, caller_context.smartfast)
        return t
    ...
    if isinstance(called, SuperCallExpression):
        ...
        sp.set_offset(expression["src"], caller_context.smartfast)
        return sp
    call_expression = CallExpression(called, arguments, type_return)
    call_expression.set_offset(src, caller_context.smartfast)
...
def _parse_elementary_type_name_expression(
    ...
    e.set_offset(expression["src"], caller_context.smartfast)
    return e
...
def parse_expression(expression: Dict, caller_context: CallerContext) -> "Expression":
    ...
    if name == "UnaryOperation":
        ...
        unary_op.set_offset(src, caller_context.smartfast)
        return unary_op
    ...
    if name == "BinaryOperation":
        ...
        binary_op.set_offset(src, caller_context.smartfast)
        return binary_op
    ...
    if name == "Conditional":
        ...
        conditional.set_offset(src, caller_context.smartfast)
        return conditional
    ...
    if name == "Assignment":
        ...
        assignement.set_offset(src, caller_context.smartfast)
        return assignement
    ...
    if name == "Literal":
        ...
        literal.set_offset(src, caller_context.smartfast)
        return literal
    ...
    if name == "Identifier":
        ...
        identifier.set_offset(src, caller_context.smartfast)
        return identifier
    ...
    if name == "IndexAccess":
        ...
        index.set_offset(src, caller_context.smartfast)
        return index
    ...
    if name == "NewExpression":
        ...
        if type_name[caller_context.get_key()] == "ArrayTypeName":
            ...
            array.set_offset(src, caller_context.smartfast)
            return array
        ...
        if type_name[caller_context.get_key()] == "ElementaryTypeName":
            ...
            new_elem.set_offset(src, caller_context.smartfast)
            return new_elem
        ...
        new.set_offset(src, caller_context.smartfast)
        return new
    ...
    if name == "ModifierInvocation":
        ...
        call.set_offset(src, caller_context.smartfast)
        return call
