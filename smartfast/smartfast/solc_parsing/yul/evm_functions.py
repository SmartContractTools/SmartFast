from smartfast.core.declarations.solidity_variables import SOLIDITY_FUNCTIONS
from smartfast.core.expressions import BinaryOperationType, UnaryOperationType
