...
from smartfast.tools.flattening.flattening import (
    Flattening,
    Strategy,
    STRATEGIES_NAMES,
    DEFAULT_EXPORT_PATH,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Contracts flattening. See https://github.com/SmartContractTools/SmartFast/wiki/Contract-Flattening",
        usage="smartfast-flat filename",
    )
