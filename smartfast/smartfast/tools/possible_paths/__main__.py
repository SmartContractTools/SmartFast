...
from smartfast.tools.possible_paths.possible_paths import (
    find_target_paths,
    resolve_functions,
...
def main():
    ...
    try:
        targets = resolve_functions(smartfast, args.targets)
    ...
    reaching_paths = find_target_paths(smartfast, targets)
