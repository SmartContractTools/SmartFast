...
from smartfast.tools.properties.properties.erc20 import generate_erc20, ERC20_PROPERTIES
from smartfast.tools.properties.addresses.address import (
    Addresses,
    OWNER_ADDRESS,
    USER_ADDRESS,
    ATTACKER_ADDRESS,
...
def main():
    ...
    contract = smartfast.get_contract_from_name(args.contract)
    if not contract:
        if len(smartfast.contracts) == 1:
            contract = smartfast.contracts[0]
        else:
