...
from smartfast.tools.similarity.info import info
from smartfast.tools.similarity.test import test
from smartfast.tools.similarity.train import train
from smartfast.tools.similarity.plot import plot

logging.basicConfig()
logger = logging.getLogger("Smartfast-simil")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Code similarity detection tool. For usage, see https://github.com/SmartContractTools/smartfast/wiki/Code-Similarity-detector"
    )
