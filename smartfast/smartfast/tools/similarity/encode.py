...
simil_logger = logging.getLogger("Smartfast-simil")
compiler_logger = logging.getLogger("CryticCompile")
compiler_logger.setLevel(logging.CRITICAL)
smartfast_logger = logging.getLogger("Smartfast")
smartfast_logger.setLevel(logging.CRITICAL)
...
def encode_contract(cfilename, **kwargs):
    ...
    # Init smartfast
    try:
        smartfast = Smartfast(cfilename, **kwargs)
