...
class WereConstant(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#variables-that-should-be-constant"
...
class BecameConstant(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#variables-that-should-not-be-constant"
