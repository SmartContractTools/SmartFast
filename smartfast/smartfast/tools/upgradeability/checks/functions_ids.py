...
def _get_function_or_variable(contract, signature):
    ...
    raise SmartfastError(f"Function id checks: {signature} not found in {contract.name}")
...
class IDCollision(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#functions-ids-collisions"
...
class FunctionShadowing(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#functions-shadowing"
