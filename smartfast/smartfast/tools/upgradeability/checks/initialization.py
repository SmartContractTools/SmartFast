...
from smartfast.tools.upgradeability.checks.abstract_checks import (
    AbstractCheck,
    CheckClassification,
)
from smartfast.utils.colors import red

logger = logging.getLogger("Smartfast-check-upgradeability")
...
def _get_all_internal_calls(function):
    all_ir = function.all_smartir_operations()
    return [
        i.function
        for i in all_ir
...
class InitializablePresent(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initializable-is-missing"
...
"""
    ...
    def _check(self):
        initializable = self.contract.smartfast.get_contract_from_name("Initializable")
...
class InitializableInherited(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initializable-is-not-inherited"
...
class InitializableInitializer(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initializer-is-missing"
...
class MissingInitializerModifier(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initializer-is-not-called"
...
class MissingCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initialize-functions-are-not-called"
...
class MultipleCalls(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initialize-functions-are-called-multiple-times"
...
class InitializeTarget(AbstractCheck):
    ...
    WIKI = "https://github.com/SmartContractTools/smartfast/wiki/Upgradeability-Checks#initialize-function"
